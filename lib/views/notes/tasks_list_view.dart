...
typedef NoteCallback = void Function(CloudTask note);

class NotesListView extends StatefulWidget {
  final Iterable<CloudTask> notes;
  final NoteCallback onDeleteNote;
  final NoteCallback onTap;
  final void Function(CloudTask, bool) onChanged;
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Icon(
                    TaskGroupIcons.icons[taskGroup] ?? Icons.task,
                    color: iconColor,
                  ),
                  Row(
                      ...
                      if (!isDone) ...[
                        ...
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: const Color(0xFF2D9BEE),
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10),
                            ),
                            elevation: 0,
